...
/**
 * Tests unitarios para las clases del modelo.
 * Verifican el comportamiento de cada clase de forma aislada.
 */
class CompetidorTest {
    ...
    void testActualizarRanking_noBajaDeUno() {
        // ranking 1, muchos puntos → sigue en 1
    ...
    void testToStringCiclistaPista_contieneSuper() {
        ...
        // debe contener info del padre (super.toString())
